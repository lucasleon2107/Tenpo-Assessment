...
import com.tenpo.assessment.security.handlers.JWTAuthenticationFailureHandler;
...
import static com.tenpo.assessment.security.SecurityConstants.*;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            if (Boolean.FALSE.equals(applicationUserService.isUserRegistered(credentials.getUserName()))) {
                authLogger.info("User doesn't exist");
                credentials = applicationUserService.signUp(credentials.getUserName(), credentials.getPassword());
            }
